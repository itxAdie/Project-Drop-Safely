    ...
    <footer className="border-t border-white/10 bg-[#060606] px-6 py-16 text-white">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-white/50">
              Drop Safely connects students with verified, safe, and affordable
              transport. We partner with top universities to ensure every
              student reaches campus and home with peace of mind.
            </p>
            <div className="mt-6 flex gap-4">
              <a
                href="https://web.facebook.com/profile.php?id=100086546385072"
                target="_blank"
                rel="noopener noreferrer"
                className="flex size-9 items-center justify-center rounded-full border border-white/15 text-white/50 transition-all hover:border-green-500/40 hover:text-green-400"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://www.instagram.com/dropsafely.pk?igsh=MWt5bGxwank1Nms2YQ=="
                target="_blank"
                rel="noopener noreferrer"
                className="flex size-9 items-center justify-center rounded-full border border-white/15 text-white/50 transition-all hover:border-green-500/40 hover:text-green-400"
              ...
              <a
                href="https://www.linkedin.com/company/drop-safely"
                target="_blank"
                rel="noopener noreferrer"
                className="flex size-9 items-center justify-center rounded-full border border-white/15 text-white/50 transition-all hover:border-green-500/40 hover:text-green-400"
                aria-label="LinkedIn"
              ...
              <a
                href="https://www.tiktok.com/@dropsafely.pk?_r=1&_t=ZS-98Nklq6uqE0"
                target="_blank"
                rel="noopener noreferrer"
                className="flex size-9 items-center justify-center rounded-full border border-white/15 text-white/50 transition-all hover:border-green-500/40 hover:text-green-400"
                aria-label="TikTok"
        ...
        <div className="mt-12 border-t border-white/5 pt-6 text-center text-xs text-white/30">
          &copy; {new Date().getFullYear()} Drop Safely. All rights reserved.
        </div>
      </div>
    </footer>
  );
